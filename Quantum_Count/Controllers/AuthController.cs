...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Register([FromBody] RegisterRequest request)
    {
        ...
        // sign in the user with Identity cookie (server-side)
    ...
    // Form POST endpoint for browser registration (sets authentication cookie)
    [AllowAnonymous]
    ...
    // Form POST endpoint for browser sign-in (sets authentication cookie)
    [AllowAnonymous]
    [HttpPost("login-form")]
    [IgnoreAntiforgeryToken]
